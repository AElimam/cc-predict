"""
    Function to populate a sample email reply given a list(s) of words, message sentiment dictionary form AWS Comprehend and a key phrases dictionary from AWS Comprehend.
